...
// (relative), a Node builtin, or a DECLARED dep. @vexa/transcript-rendering is the
// pure, framework-agnostic transcript→view projection; it must import nothing it
// hasn't declared, so any consumer can take it standalone.
