...
// a Node builtin, or a DECLARED dep. @vexa/mixed-pipeline may pull the shared engine
// (@vexa/transcribe-{buffer,whisper}) + the pyannote runtime (@huggingface/transformers,
// onnxruntime-node) — never another brick's internals, never the monolith.
