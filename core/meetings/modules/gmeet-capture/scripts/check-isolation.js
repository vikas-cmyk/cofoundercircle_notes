...
// a DECLARED dep. @vexa/gmeet-capture is PAGE code: it may pull @vexa/capture-codec (the capture.v1
// SSOT) + declared devDeps — never another brick's internals, never node/Playwright. (DOM globals
// like document/AudioContext are ambient, not imports, so they're not scanned.)
