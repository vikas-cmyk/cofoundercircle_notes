...
// a DECLARED dep. @vexa/record-chunker is PURE BROWSER code: it drives a MediaRecorder over a combined
// audio MediaStream with ZERO external imports (only declared devDeps) — never another brick's
// internals, never node/Playwright. (Browser globals like MediaRecorder/AudioContext/document/window/
// btoa are ambient, not imports, so they're not scanned.)
