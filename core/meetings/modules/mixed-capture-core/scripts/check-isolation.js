...
// a DECLARED dep. @vexa/mixed-capture-core is PAGE code: it is pure DOM/WebAudio with ZERO external
// imports (only declared devDeps) — never another brick's internals, never node/Playwright. (DOM
// globals like AudioContext/MediaStream/RTCPeerConnection are ambient, not imports, so they're not scanned.)
