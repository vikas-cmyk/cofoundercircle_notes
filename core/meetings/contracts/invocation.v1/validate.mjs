#!/usr/bin/env node
/** gate:schema for invocation.v1 — golden `<Shape>.<case>.json` validates against #/$defs/<Shape>. */
...
console.log(failed ? `invocation.v1: ${failed} golden(s) FAILED` : `invocation.v1: ${files.length} goldens conform`);
